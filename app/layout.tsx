...
export const metadata: Metadata = {
  ...
  title: {
    default: "Imperial Associates | Survey, BIM & MEP",
    template: "%s | Imperial Associates",
  },
  description:
    "Imperial Associates in Raichur, Karnataka, India delivers survey (DGPS & drone), BIM & MEP services, civil construction, and architecture & interior design—end to end.",
  keywords: [
    "Imperial Associates",
    "Raichur",
    "Karnataka",
    ...
    "BIM services",
    "MEP services",
    "BIM services in India",
    "BIM services in Karnataka",
    "MEP services in India",
    "MEP services in Karnataka",
    "Survey services in India",
    "Survey services in Karnataka",
    "Civil construction",
    "Interior design",
  ],
  robots: {
  ...
  openGraph: {
    ...
    title: "Imperial Associates | Survey, BIM & MEP",
    description:
      "Survey (DGPS & drone), BIM & MEP services, civil construction, and interiors—based in Raichur, Karnataka, India.",
...
export default function RootLayout({
  ...
  const organizationLd = {
    ...
    serviceArea: ["Raichur", "Karnataka", "India"],
    knowsAbout: [
      "Survey",
      "Land Survey",
      "Topographic Survey",
